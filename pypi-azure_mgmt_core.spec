...
Source0  : https://files.pythonhosted.org/packages/3e/99/fa9e7551313d8c7099c89ebf3b03cd31beb12e1b498d575aa19bb59a5d04/azure_mgmt_core-1.6.0.tar.gz
...
%prep
%setup -q -n azure_mgmt_core-1.6.0
cd %{_builddir}/azure_mgmt_core-1.6.0
pushd ..
cp -a azure_mgmt_core-1.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751550404
