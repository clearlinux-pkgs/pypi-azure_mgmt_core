...
Source0  : https://files.pythonhosted.org/packages/48/9a/9bdc35295a16fe9139a1f99c13d9915563cbc4f30b479efaa40f8694eaf7/azure_mgmt_core-1.5.0.tar.gz
...
%prep
%setup -q -n azure_mgmt_core-1.5.0
cd %{_builddir}/azure_mgmt_core-1.5.0
pushd ..
cp -a azure_mgmt_core-1.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730416931
...
cp %{_builddir}/azure_mgmt_core-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-azure_mgmt_core/5d941660d20397d61e58adb87e2dd05fa60828ef || :
cp %{_builddir}/azure_mgmt_core-%{version}/LICENSE.md %{buildroot}/usr/share/package-licenses/pypi-azure_mgmt_core/579cbb785bfbb1c60b923fc50948313e74cb168c || :
