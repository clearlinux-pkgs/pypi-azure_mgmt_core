...
Source0  : https://files.pythonhosted.org/packages/1d/75/c67445c849d133e8b4c19909b6bef27f7c890468f4f519fc15c5176511e0/azure-mgmt-core-1.3.1.zip
...
%prep
%setup -q -n azure-mgmt-core-1.3.1
cd %{_builddir}/azure-mgmt-core-1.3.1
pushd ..
cp -a azure-mgmt-core-1.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656359816
...
cp %{_builddir}/azure-mgmt-core-1.3.1/LICENSE.md %{buildroot}/usr/share/package-licenses/pypi-azure_mgmt_core/579cbb785bfbb1c60b923fc50948313e74cb168c
